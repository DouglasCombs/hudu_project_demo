...
import Svg, {G, Rect, SvgProps, Path} from 'react-native-svg';
import {Colors} from '~/styles';

const StarSquare = ({
  fillColor = Colors.WHITE_F,
  strokeColor = Colors.SEARCH_BACKGROUND,
  starColor = Colors.Ghost,
  ...props
}: {
  fillColor?: string;
  strokeColor?: string;
  ...
  <Svg {...props} width={59} height={48}>
    <G fill={fillColor} stroke={strokeColor} data-name="Rectangle 6187">
